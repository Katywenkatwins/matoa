...
***************************************************************************** */
    ...
    let seriesElement, categoriesElements;
    function windowLoad() {
    ...
    async function loadProducts(start = 0, limit = 9) {
        const productsJson = "files/json/series.json";
    ...
    function setProducts(products, start, limit) {
        ...
        productsArray.forEach(((product, index) => {
            if (index >= start && index < limit + start) {
                ...
                let seriesItems;
                if (1 === category) seriesItems = document.querySelector("#cat-01");
                if (2 === category) seriesItems = document.querySelector("#cat-02");
                if (3 === category) seriesItems = document.querySelector("#cat-03");
                seriesItems.insertAdjacentHTML("beforeend", productTemplate);
            }
        }));
    }
    ...
    function documentActions(e) {
        const targetElement = e.target;
        if (targetElement.closest(".footer-series__button")) {
            const productsQuantity = document.querySelectorAll(".series__item").length;
